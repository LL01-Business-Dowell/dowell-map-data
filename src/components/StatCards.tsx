  ...
  return (
    ...
    >
      <div className="bg-white p-4 rounded-lg shadow-md flex items-center h-full">
        <div className="h-12 w-12 rounded-lg bg-blue-100 flex items-center justify-center flex-shrink-0 mr-4">
      ...
      <div className="bg-white p-4 rounded-lg shadow-md flex items-center h-full">
        <div className="h-12 w-12 rounded-lg bg-green-100 flex items-center justify-center flex-shrink-0 mr-4">
        ...
        <div className="flex flex-col justify-center">
          <p className="text-gray-500 text-sm h-10">Total<br />Cities</p>
      ...
      <div className="bg-white p-4 rounded-lg shadow-md flex items-center h-full">
        <div className="h-12 w-12 rounded-lg bg-yellow-100 flex items-center justify-center flex-shrink-0 mr-4">
      ...
      <div className="bg-white p-4 rounded-lg shadow-md flex items-center h-full">
        <div className="h-12 w-12 rounded-lg bg-purple-100 flex items-center justify-center flex-shrink-0 mr-4">
